...
tweets=twitteR::userTimeline("narendramodi",n = 1000)
...
write.csv(twetsdf ,"narendramodi.cvs")
write.table(twetsdf ,"narendramodi-tweets.txt")
...
df
barplot(sort(df),col = 1:8,horiz = T,xlab = "persentage of emotion",ylab = "emotions",main = "modi-twitter-analysis")

print("sentmental analysis completed")

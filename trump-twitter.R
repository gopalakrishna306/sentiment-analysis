...
tweets=twitteR::userTimeline("realDonaldTrump",n = 1000)
...
write.csv(twetsdf ,"realDonaldTrump.cvs")
write.table(twetsdf ,"realDonaldTrump-tweets.txt")
...
nqwrd=c("well","can","aur","one","hai","may","haha","also","alwas","tha","man","nahi")
nqwrd
...
barplot(sort(df),col = 1:8,horiz = T,xlab = "persentage of emotion",ylab = "emotions",main = " trump twitter-analysis")

print("trump twitter senetment analysis completd")

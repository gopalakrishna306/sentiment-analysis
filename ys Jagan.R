...
tweets=twitteR::userTimeline("ysjagan",n = 1000)
...
write.csv(twetsdf ,"ysjagan.cvs")
write.table(twetsdf ,"ysjagan-tweets.txt")
...
nqwrd=c("give","sri","amp","day","will","today","may","sri","met","every","see","shri")
nqwrd
...
barplot(sort(df),col = 1:8,horiz = T,xlab = "persentage of emotion",ylab = "emotions",main = " ys jagan twitter-analysis")
